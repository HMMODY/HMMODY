...
local HMMODY = io.open("HMMODY", 'w')
HMMODY:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 HMMODY.lua
done
]])
HMMODY:close()
...
screen -S HMMODY ./HMMODY
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x HMMODY;chmod +x Run;./Run')
end
...
HMMODY = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..HMMODY)
LuaTele = luatele.set_config{api_id=12710737,api_hash='141c77d7a7f61483ce4e736031326413',session_name=HMMODY,token=Token}
function var(value)  
...
Status = 0
Developers = Redis:sismember(HMMODY.."HMMODY:Developers:Groups",UserId) 
TheBasics = Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(HMMODY.."HMMODY:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(HMMODY.."HMMODY:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(HMMODY.."HMMODY:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 100100900 then
Status = 'مطور السورس'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == HMMODY then
Status = 'البوت'
elseif Developers then
Status = Redis:get(HMMODY.."HMMODY:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(HMMODY.."HMMODY:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(HMMODY.."HMMODY:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(HMMODY.."HMMODY:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(HMMODY.."HMMODY:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(HMMODY.."HMMODY:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الكروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن الكروب'
elseif Distinguished then
Status = Redis:get(HMMODY.."HMMODY:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(HMMODY.."HMMODY:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(HMMODY.."HMMODY:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(HMMODY.."HMMODY:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(HMMODY.."HMMODY:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(HMMODY.."HMMODY:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(HMMODY.."HMMODY:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(HMMODY.."HMMODY:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(HMMODY.."HMMODY:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(HMMODY.."HMMODY:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(HMMODY.."HMMODY:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(HMMODY.."HMMODY:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(HMMODY.."HMMODY:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(HMMODY.."HMMODY:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(HMMODY.."HMMODY:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(HMMODY.."HMMODY:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(HMMODY.."HMMODY:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(HMMODY.."HMMODY:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(HMMODY.."HMMODY:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(HMMODY.."HMMODY:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(HMMODY.."HMMODY:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(HMMODY.."HMMODY:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(HMMODY.."HMMODY:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(HMMODY.."HMMODY:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(HMMODY.."HMMODY:BanAll:Groups",UserId) ,
ktmall = Redis:sismember(HMMODY.."HMMODY:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(HMMODY.."HMMODY:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(HMMODY.."HMMODY:SilentGroup:Group"..ChatId,UserId)
}
end
...
Status = nil
DevelopersQ = Redis:sismember(HMMODY.."HMMODY:DevelopersQ:Groups",UserId) 
Developers = Redis:sismember(HMMODY.."HMMODY:Developers:Groups",UserId) 
TheBasics = Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(HMMODY.."HMMODY:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(HMMODY.."HMMODY:Managers:Group"..ChatId,UserId)
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,HMMODY).status
if GetMemberStatus.can_change_info then
...
local msg_id = msg.id
Redis:incr(HMMODY..'HMMODY:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(HMMODY) then
...
elseif tonumber(msg.sender.user_id) == 665877797 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1930922865 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(HMMODY.."HMMODY:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(HMMODY.."HMMODY:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(HMMODY.."HMMODY:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(HMMODY.."HMMODY:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(HMMODY.."HMMODY:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(HMMODY.."HMMODY:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(HMMODY.."HMMODY:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(HMMODY.."HMMODY:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(HMMODY.."HMMODY:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(HMMODY.."HMMODY:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(HMMODY.."HMMODY:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(HMMODY.."HMMODY:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(HMMODY) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(HMMODY.."HMMODY:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(HMMODY.."HMMODY:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(HMMODY.."HMMODY:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(HMMODY.."HMMODY:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
UserInfousername = '@'..UserInfo.username
else
UserInfousername = 'معنده '
end
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(HMMODY) then
return false
end
local floods = Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(HMMODY.."HMMODY:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- قام بالتكراربالكروب وتم طرده").Reply,"md",true)
end
if type == "del" then 
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if type == "keed" then
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0}), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- قام بالتكراربالكروب وتم تقيده").Reply,"md",true)  
end
if type == "mute" then
Redis:sadd(HMMODY.."HMMODY:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- قام بالتكرار بالكروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(HMMODY.."HMMODY:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(HMMODY.."HMMODY:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(HMMODY.."HMMODY:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(HMMODY.."HMMODY:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(HMMODY.."HMMODY:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(HMMODY.."HMMODY:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(HMMODY.."HMMODY:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(HMMODY.."HMMODY:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(HMMODY.."HMMODY:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(HMMODY.."HMMODY:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(HMMODY.."HMMODY:lockpin"..msg_chat_id)
...
Redis:incr(HMMODY.."HMMODY:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(HMMODY.."HMMODY:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(HMMODY.."HMMODY:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(HMMODY.."HMMODY:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(HMMODY.."HMMODY:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(HMMODY.."HMMODY:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(HMMODY.."HMMODY:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(HMMODY.."HMMODY:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(HMMODY.."HMMODY:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(HMMODY.."HMMODY:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(HMMODY.."HMMODY:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(HMMODY.."HMMODY:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(HMMODY.."HMMODY:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(HMMODY.."HMMODY:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(HMMODY.."HMMODY:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(HMMODY.."HMMODY:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(HMMODY.."HMMODY:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(HMMODY.."HMMODY:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(HMMODY.."HMMODY:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(HMMODY.."HMMODY:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(HMMODY..'HMMODY:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(HMMODY.."HMMODY:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(HMMODY.."HMMODY:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(HMMODY.."HMMODY:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(HMMODY.."HMMODY:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(HMMODY.."HMMODY:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(HMMODY.."HMMODY:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(HMMODY.."HMMODY:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(HMMODY.."HMMODY:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(HMMODY..'HMMODY:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n- ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(HMMODY..'HMMODY:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(HMMODY.."HMMODY:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(HMMODY.."HMMODY:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(HMMODY.."HMMODY:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(HMMODY..'HMMODY:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n- تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(HMMODY..'HMMODY:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(HMMODY.."HMMODY:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(HMMODY.."HMMODY:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(HMMODY.."HMMODY:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(HMMODY.."HMMODY:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(HMMODY.."HMMODY:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(HMMODY.."HMMODY:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(HMMODY.."HMMODY:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(HMMODY.."HMMODY:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(HMMODY..'HMMODY:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(HMMODY.."HMMODY:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(HMMODY.."HMMODY:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(HMMODY.."HMMODY:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(HMMODY.."HMMODY:All:Get:Reides:Commands:Group"..text)
Redis:del(HMMODY.."HMMODY:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(HMMODY.."HMMODY:All:Command:List:Group",text)
LuaTele.sendText(msg_chat_id,msg_id,"- تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"- معنده امر بهاذا الاسم","md",true)
end
Redis:del(HMMODY.."HMMODY:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(HMMODY.."HMMODY:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(HMMODY.."HMMODY:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(HMMODY.."HMMODY:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(HMMODY.."HMMODY:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"- ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(HMMODY.."HMMODY:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(HMMODY.."HMMODY:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(HMMODY.."HMMODY:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(HMMODY.."HMMODY:All:Command:List:Group",text)
Redis:del(HMMODY.."HMMODY:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حفظ الامر باسم ← { "..text..' }',"md",true)
end

if text and Redis:get(HMMODY.."HMMODY:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(HMMODY.."HMMODY:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(HMMODY.."HMMODY:Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"- تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"- معنده امر بهاذا الاسم","md",true)
end
Redis:del(HMMODY.."HMMODY:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(HMMODY.."HMMODY:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(HMMODY.."HMMODY:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(HMMODY.."HMMODY:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(HMMODY.."HMMODY:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"- ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(HMMODY.."HMMODY:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(HMMODY.."HMMODY:Command:Reids:Group:New"..msg_chat_id)
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(HMMODY.."HMMODY:Command:List:Group"..msg_chat_id,text)
Redis:del(HMMODY.."HMMODY:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(HMMODY.."HMMODY:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(HMMODY.."HMMODY:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(HMMODY.."HMMODY:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(HMMODY.."HMMODY:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(HMMODY.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(HMMODY.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"- تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(HMMODY.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(HMMODY.."HMMODY:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حفظ ترحيب الكروب","md",true)     
end
if Redis:get(HMMODY.."HMMODY:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(HMMODY.."HMMODY:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"- تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(HMMODY.."HMMODY:Group:Rules" .. msg_chat_id,text) 
Redis:del(HMMODY.."HMMODY:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حفظ قوانين الكروب","md",true)  
end  
if Redis:get(HMMODY.."HMMODY:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(HMMODY.."HMMODY:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text  then
local test = Redis:get(HMMODY.."HMMODY:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(HMMODY.."HMMODY:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(HMMODY.."HMMODY:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(HMMODY.."HMMODY:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(HMMODY.."HMMODY:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(HMMODY.."HMMODY:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حفظ رد للمدير بنجاح \n- ارسل ( "..test.." ) لرؤيه الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(HMMODY.."HMMODY:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(HMMODY.."HMMODY:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(HMMODY.."HMMODY:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(HMMODY.."HMMODY:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(HMMODY.."HMMODY:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(HMMODY.."HMMODY:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(HMMODY.."HMMODY:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"- تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(HMMODY.."HMMODY:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:Video"..text)
local document = Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:File"..text)
local audio = Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(HMMODY..'HMMODY:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(HMMODY..'HMMODY:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local Text = Text:gsub('#username',(UserInfo.username or 'معنده ')) 
...
if text and Redis:get(HMMODY.."HMMODY:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(HMMODY..'HMMODY:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(HMMODY..'HMMODY:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local Texingt = Texingt:gsub('#username',(UserInfo.username or 'معنده')) 
...
if text then
local test = Redis:get(HMMODY.."HMMODY:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(HMMODY.."HMMODY:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(HMMODY.."HMMODY:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(HMMODY.."HMMODY:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(HMMODY.."HMMODY:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(HMMODY.."HMMODY:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(HMMODY.."HMMODY:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(HMMODY.."HMMODY:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(HMMODY.."HMMODY:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(HMMODY.."HMMODY:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(HMMODY.."HMMODY:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
- ارسل لي الرد سواء كان .
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(HMMODY.."HMMODY:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(HMMODY..'HMMODY:'..v..text)
end
Redis:del(HMMODY.."HMMODY:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(HMMODY.."HMMODY:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(HMMODY.."HMMODY:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر -' then   
Redis:del(HMMODY.."HMMODY:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(HMMODY.."HMMODY:ChekBotAdd") 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(HMMODY.."HMMODY:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر -' then   
Redis:del(HMMODY.."HMMODY:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(HMMODY.."HMMODY:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر -' then   
Redis:del(HMMODY.."HMMODY:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء الاذاعه بالتوجيه خاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(HMMODY.."HMMODY:Num:User:Pv")   
LuaTele.sendText(msg_chat_id,msg_id,"- تم التوجيه الى *- "..#list.." * مجموعه في البوت ","md",true) 
for k,v in pairs(list) do  
...
if text and Redis:get(HMMODY..'HMMODY:GetTexting:DevHMMODY'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر -' then 
Redis:del(HMMODY..'HMMODY:GetTexting:DevHMMODY'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'- تم الغاء حفظ كليشة المطور')
end
Redis:set(HMMODY..'HMMODY:Texting:DevHMMODY',text)
Redis:del(HMMODY..'HMMODY:GetTexting:DevHMMODY'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'- تم حفظ كليشة المطور')
end
if Redis:get(HMMODY.."HMMODY:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(HMMODY.."HMMODY:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(HMMODY.."HMMODY:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(HMMODY.."HMMODY:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'- تم تعين الايدي عام',"md",true)  
end
if Redis:get(HMMODY.."HMMODY:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء امر تعين الايدي","md",true)  
Redis:del(HMMODY.."HMMODY:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(HMMODY.."HMMODY:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(HMMODY.."HMMODY:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'- تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(HMMODY.."HMMODY:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر -' then   
Redis:del(HMMODY.."HMMODY:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(HMMODY.."HMMODY:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(HMMODY.."HMMODY:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "-  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(HMMODY.."HMMODY:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر -' then   
Redis:del(HMMODY.."HMMODY:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء امر تغيير كليشه start","md",true)  
end 
Redis:del(HMMODY.."HMMODY:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(HMMODY.."HMMODY:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "-  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(HMMODY.."HMMODY:Game:Smile"..msg.chat_id) then
if text == Redis:get(HMMODY.."HMMODY:Game:Smile"..msg.chat_id) then
Redis:incrby(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(HMMODY.."HMMODY:Game:Smile"..msg.chat_id)
...
if Redis:get(HMMODY.."HMMODY:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(HMMODY.."HMMODY:Game:Monotonous"..msg.chat_id) then
Redis:del(HMMODY.."HMMODY:Game:Monotonous"..msg.chat_id)
Redis:incrby(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(HMMODY.."HMMODY:Game:Riddles"..msg.chat_id) then
if text == Redis:get(HMMODY.."HMMODY:Game:Riddles"..msg.chat_id) then
Redis:incrby(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(HMMODY.."HMMODY:Game:Riddles"..msg.chat_id)
...
if Redis:get(HMMODY.."HMMODY:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(HMMODY.."HMMODY:Game:Meaningof"..msg.chat_id) then
Redis:incrby(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(HMMODY.."HMMODY:Game:Meaningof"..msg.chat_id)
...
if Redis:get(HMMODY.."HMMODY:Game:Reflection"..msg.chat_id) then
if text == Redis:get(HMMODY.."HMMODY:Game:Reflection"..msg.chat_id) then
Redis:incrby(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(HMMODY.."HMMODY:Game:Reflection"..msg.chat_id)
...
if Redis:get(HMMODY.."HMMODY:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"- اسف لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(HMMODY.."HMMODY:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(HMMODY.."HMMODY:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(HMMODY.."HMMODY:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"- مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(HMMODY.."HMMODY:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(HMMODY.."HMMODY:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(HMMODY.."HMMODY:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(HMMODY.."HMMODY:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(HMMODY.."HMMODY:Game:Difference"..msg.chat_id) then
if text == Redis:get(HMMODY.."HMMODY:Game:Difference"..msg.chat_id) then 
Redis:del(HMMODY.."HMMODY:Game:Difference"..msg.chat_id)
Redis:incrby(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(HMMODY.."HMMODY:Game:Example"..msg.chat_id) then
if text == Redis:get(HMMODY.."HMMODY:Game:Example"..msg.chat_id) then 
Redis:del(HMMODY.."HMMODY:Game:Example"..msg.chat_id)
Redis:incrby(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(HMMODY.."HMMODY:All:Get:Reides:Commands:Group"..text) or Redis:get(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/HMMODY'}, },}}
...
if tonumber(HMMODY) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'- عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(HMMODY..'HMMODY:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(HMMODY.."HMMODY:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(HMMODY.."HMMODY:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(HMMODY.."HMMODY:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(HMMODY.."HMMODY:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(HMMODY.."HMMODY:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(HMMODY.."HMMODY:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(HMMODY) then 
return LuaTele.sendText(msg_chat_id,msg_id,'- عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(HMMODY.."HMMODY:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(HMMODY.."HMMODY:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(HMMODY.."HMMODY:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(HMMODY.."HMMODY:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(HMMODY.."HMMODY:TheBasics:Group"..idg,idASAS)
end;end
end
...
--download('https://raw.githubusercontent.com/LARICATEAM/HMMODY/master/HMMODY.lua','HMMODY.lua')
...
Redis:del(HMMODY.."HMMODY:SendBcBot") 
...
Redis:set(HMMODY.."HMMODY:SendBcBot",true) 
...
Redis:del(HMMODY.."HMMODY:LeftBot") 
...
Redis:set(HMMODY.."HMMODY:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(HMMODY.."HMMODY:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر -' then   
Redis:del(HMMODY.."HMMODY:AddSudosNew"..msg_chat_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n- اسف معنده حساب بهاذا المعرف ","md",true)  
end
if UserId_Info.type.is_channel == true then
return LuaTele.sendText(msg_chat_id,msg_id,"\n- اسف لا تستطيع استخدام معرف قناة او كروب ","md",true)  
end
if UserName and UserName[2]:match('(%S+)[Bb][Oo][Tt]') then
return LuaTele.sendText(msg_chat_id,msg_id,"\n- اسف لا تستطيع استخدام معرف البوت ","md",true)  
end
local Informationlua = io.open("Information.lua", 'w')
Informationlua:write([[
return {
...
Redis:set(HMMODY.."HMMODY:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(HMMODY..'HMMODY:ChekBotAdd')  
local UsersBot = Redis:smembers(HMMODY..'HMMODY:Num:User:Pv')  
local Get_Json = '{"BotId": '..HMMODY..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(HMMODY.."HMMODY:TheBasics:Group"..v)
local Constructor = Redis:smembers(HMMODY.."HMMODY:Originators:Group"..v)
local Manager = Redis:smembers(HMMODY.."HMMODY:Managers:Group"..v)
local Admin = Redis:smembers(HMMODY.."HMMODY:Addictive:Group"..v)
local Vips = Redis:smembers(HMMODY.."HMMODY:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(HMMODY..'HMMODY:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*- عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n- عدد الكروبات : '..(Redis:scard(HMMODY..'HMMODY:ChekBotAdd') or 0)..'\n- عدد المشتركين : '..(Redis:scard(HMMODY..'HMMODY:Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'تفعيل' and msg.Developers then
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*- اسف البوت ليس ادمن بالكروب يرجى رفعه وتفعيل الصلاحيات له *","md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if Redis:sismember(HMMODY.."HMMODY:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(HMMODY..'HMMODY:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'- عدد الاعضاء قليل لا يمكن تفعيل الكروب  يجب ان يكوم اكثر من :'..Redis:get(HMMODY..'HMMODY:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(HMMODY.."HMMODY:ChekBotAdd",msg_chat_id)
Redis:set(HMMODY.."HMMODY:Status:Id"..msg_chat_id,true) ;Redis:set(HMMODY.."HMMODY:Status:Reply"..msg_chat_id,true) ;Redis:set(HMMODY.."HMMODY:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(HMMODY.."HMMODY:Status:BanId"..msg_chat_id,true) ;Redis:set(HMMODY.."HMMODY:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(HMMODY.."HMMODY:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(HMMODY.."HMMODY:ChekBotAdd",msg_chat_id) then
...
Redis:srem(HMMODY.."HMMODY:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(HMMODY.."HMMODY:ChekBotAdd",msg_chat_id) then
if text == "ايدي" and msg.reply_to_message_id == 0 then
if not Redis:get(HMMODY.."HMMODY:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(HMMODY..'HMMODY:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(HMMODY..'HMMODY:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(HMMODY.."HMMODY:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {'ملاك وناسيك بكروبنه',"حلغوم والله ","اطلق صوره","كيكك والله","لازك بيها غيرها ",}
...
Get_Is_Id = Redis:get(HMMODY.."HMMODY:Set:Id:Groups") or Redis:get(HMMODY.."HMMODY:Set:Id:Group"..msg_chat_id)
if Redis:get(HMMODY.."HMMODY:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(HMMODY..'HMMODY:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(HMMODY..'HMMODY:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(HMMODY.."HMMODY:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
elseif (StatusMember == "chatMemberStatusAdministrator") then
StatusMemberChat = 'مشرف بالكروب'
else
StatusMemberChat = 'عضو بالكروب'
end
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(HMMODY..'HMMODY:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,HMMODY).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'- البوت عضوب الكروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,HMMODY).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(HMMODY.."HMMODY:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(HMMODY.."HMMODY:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تنزيله من المالكين مسبقا . ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تنزيله من المنشئين الاساسين مسبقا . ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تنزيله من المنشئين الاساسين . ").Reply,"md",true)  
end
end
...
if not Redis:sismember(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"-  تم تنزيله من المنشئين مسبقا . . ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تنزيله من المدراء مسبقا .").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تنزيله من الادمنيه مسبقا .").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تنزيله من المميزين مسبقا .").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n- اسف تستطيع فقط استخدام الامر على المستخدمين ","md",true)  
end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n- اسف لا تستطيع استخدام الامر على البوت ","md",true)  
end
...
if not Redis:sismember(HMMODY.."HMMODY:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(HMMODY.."HMMODY:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(HMMODY.."HMMODY:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم تنزيله من قائمه المطورين مسبقا  . ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم تنزيله من قائمه المطورين   . ").Reply,"md",true)  
end
end
...
if not Redis:sismember(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم تنزيله من المنشئين الاساسين مسبقا .").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم تنزيله من المنشئين الاساسين  .").Reply,"md",true)  
end
end
...
if not Redis:sismember(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n- اسف لا تستطيع استخدام ايدي خطأ ","md",true)  
end
if UserInfo.message == "Invalid user ID" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n- اسف تستطيع فقط استخدام الامر على المستخدمين ","md",true)  
end
...
if not Redis:sismember(HMMODY.."HMMODY:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(HMMODY.."HMMODY:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Developers:Groups",UserId) 
...
if not Redis:sismember(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله من المالكين مسبقا .").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله من المنشئين الاساسين مسبقا .").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله من المنشئين الاساسين  .").Reply,"md",true)  
end
end
...
if not Redis:sismember(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"-  تم تنزيله من المنشئين مسبقا . ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله من المدراء مسبقا .").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله من الادمنيه مسبقا .").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله من المميزين مسبقا . ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(HMMODY.."HMMODY:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم رفعه ثانوي مسبقا . ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم رفعه ثانوي .").Reply,"md",true)  
end
end 
if UserName[1] == "مطور" then
if not msg.DevelopersQ then
...
if Redis:sismember(HMMODY.."HMMODY:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم رفعه مطور مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم رفعه مالك مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم رفعه منشئ اساسي مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم رفعه منشئ  مسبقا . ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم رفعه مدير  مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(HMMODY.."HMMODY:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم رفعه ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم رفعه مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(HMMODY.."HMMODY:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(HMMODY.."HMMODY:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(HMMODY.."HMMODY:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعه مطور مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعه مالك مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعه منشئ  مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعه مدير  مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعه ادمن  مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم رفعه مميز  مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(HMMODY.."HMMODY:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم رفعه مطور ثانوي مسبقا ز").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(HMMODY.."HMMODY:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم رفعه مطور مسبقا . ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Developers:Groups",UserId) 
...
if Redis:sismember(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم رفعه مالك مسبقا . ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم رفعه منشئ اساسي مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم رفعه منشئ  مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم رفعه مدير  مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم رفعه ادمن  مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم رفعه مميز  مسبقا .").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(HMMODY.."HMMODY:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(HMMODY.."HMMODY:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(HMMODY.."HMMODY:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(HMMODY.."HMMODY:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(HMMODY.."HMMODY:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(HMMODY.."HMMODY:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(HMMODY.."HMMODY:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:DevelopersQ:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده مطورين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده مطورين حاليا , ","md",true)  
end
ListMembers = '\n*- قائمه مطورين البوت \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده مالكين حاليا , ","md",true)  
end
ListMembers = '\n*- قائمه المالكين \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده منشئين اساسيين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده منشئين حاليا , ","md",true)  
end
ListMembers = '\n*- قائمه المنشئين  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده مدراء حاليا , ","md",true)  
end
ListMembers = '\n*- قائمه المدراء  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده ادمنيه حاليا , ","md",true)  
end
ListMembers = '\n*- قائمه الادمنيه  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده مميزين حاليا . ","md",true)  
end
ListMembers = '\n*- قائمه المميزين  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:BanAll:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده محظورين عام حاليا , ","md",true)  
end
ListMembers = '\n*- قائمه المحظورين عام  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:ktmAll:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده مكتومين عام حاليا . ","md",true)  
end
ListMembers = '\n*- قائمه المكتومين عام  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده محظورين حاليا . ","md",true)  
end
ListMembers = '\n*- قائمه المحظورين  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده مكتومين حاليا . ","md",true)  
end
ListMembers = '\n*- قائمه المكتومين  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
Redis:set(HMMODY.."HMMODY:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(HMMODY.."HMMODY:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(HMMODY.."HMMODY:Status:Id"..msg_chat_id,true) 
...
Redis:set(HMMODY.."HMMODY:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(HMMODY.."HMMODY:Status:Reply"..msg_chat_id,true) 
...
Redis:set(HMMODY.."HMMODY:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(HMMODY.."HMMODY:Status:BanId"..msg_chat_id,true) 
...
Redis:set(HMMODY.."HMMODY:BotFree",true) 
...
Redis:set(HMMODY.."HMMODY:TwaslBot",true) 
...
if TextMsg == 'الرابط' then
Redis:del(HMMODY.."HMMODY:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(HMMODY.."HMMODY:Status:Welcome"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:Status:Id"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:Status:Reply"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:Status:BanId"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:BotFree") 
...
Redis:del(HMMODY.."HMMODY:TwaslBot") 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*- اسف لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,UserId_Info.id).." } *","md",true)  
end
if Redis:sismember(HMMODY.."HMMODY:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم حظره عام من الكروبات مسبقا ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(HMMODY.."HMMODY:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم الغاء حظره عام من الكروبات مسبقا ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(HMMODY.."HMMODY:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم كتمه عام من الكروبات مسبقا ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(HMMODY.."HMMODY:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم الغاء كتمه عام من الكروبات مسبقا ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(HMMODY.."HMMODY:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم كتمهبالكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم كتمهبالكروب  ").Reply,"md",true)  
end
end
...
if not Redis:sismember(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تقيده بالكروب \n- لمدة : "..UserName[1]..' '..UserName[2]).Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*- اسف لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,Message_Reply.sender.user_id).." } *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم تقيده بالكروب \n- لمدة : "..TimeKed[1]..' '..TimeKed[2]).Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*- اسف لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,UserId[3]).." } *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تقيدهبالكروب ").Reply,"md",true)  
end

if text and text:match('^الغاء التقيد @(%S+)$') then
local UserName = text:match('^الغاء التقيد @(%S+)$')
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*- هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم الغاء تقيده من الكروب").Reply,"md",true)  
end
...
if Redis:sismember(HMMODY.."HMMODY:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(HMMODY.."HMMODY:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(HMMODY.."HMMODY:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(HMMODY.."HMMODY:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(HMMODY.."HMMODY:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(HMMODY.."HMMODY:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(HMMODY.."HMMODY:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(HMMODY.."HMMODY:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم كتمهبالكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم كتمهبالكروب  ").Reply,"md",true)  
end
end
...
if not Redis:sismember(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم تقيدهبالكروب ").Reply,"md",true)  
end

if text == ('الغاء التقيد') and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*- هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم الغاء تقيده من الكروب").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*- اسف لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,UserId).." } *","md",true)  
end
if Redis:sismember(HMMODY.."HMMODY:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم حظره عام من الكروبات مسبقا ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:BanAll:Groups",UserId) 
...
if Redis:sismember(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم كتمهبالكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم كتمهبالكروب  ").Reply,"md",true)  
end
end
...
if not Redis:sismember(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم تقيدهبالكروب ").Reply,"md",true)  
end

if text and text:match('^الغاء التقيد (%d+)$') then
local UserId = text:match('^الغاء التقيد (%d+)$')
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*- هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم الغاء تقيده من الكروب").Reply,"md",true)  
end
...
if text == "نزلني" then
if not Redis:get(HMMODY.."HMMODY:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(HMMODY.."HMMODY:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(HMMODY.."HMMODY:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(HMMODY.."HMMODY:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(HMMODY.."HMMODY:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(HMMODY.."HMMODY:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(HMMODY.."HMMODY:Status:KickMe"..msg_chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*- اسف لا تستطيع استخدام الامر على { "..Controller(msg_chat_id,msg.sender.user_id).." } *","md",true)  
end
local StatusMember = LuaTele.getChatMember(msg_chat_id,msg.sender.user_id).status.luatele
if (StatusMember == "chatMemberStatusCreator") then
KickMe = true
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(HMMODY.."HMMODY:LeftBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*- امر المغادره معطل من قبل المطورالاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/HMMODY'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n- عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
Redis:set(HMMODY.."HMMODY:Lock:text"..msg_chat_id,true) 
...
Redis:set(HMMODY.."HMMODY:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(HMMODY.."HMMODY:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(HMMODY.."HMMODY:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(HMMODY.."HMMODY:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(HMMODY.."HMMODY:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(HMMODY.."HMMODY:Lock:edit"..msg_chat_id,true) 
...
Redis:set(HMMODY.."HMMODY:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(HMMODY..'HMMODY:'..lock..msg_chat_id,"del")    
end
...
Redis:del(HMMODY.."HMMODY:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(HMMODY.."HMMODY:Lock:text"..msg_chat_id)  
...
Redis:del(HMMODY.."HMMODY:Lock:Join"..msg_chat_id)  
...
Redis:del(HMMODY.."HMMODY:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(HMMODY.."HMMODY:Lock:tagservr"..msg_chat_id)  
...
Redis:del(HMMODY.."HMMODY:lockpin"..msg_chat_id)  
...
Redis:del(HMMODY.."HMMODY:Lock:edit"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(HMMODY..'HMMODY:'..lock..msg_chat_id)    
end
...
Redis:hset(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(HMMODY.."HMMODY:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(HMMODY.."HMMODY:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Link"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:User:Name"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:hashtak"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Cmd"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Photo"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Video"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Animation"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:geam"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Audio"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:vico"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Sticker"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:forward"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Document"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Contact"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Spam"..msg_chat_id)  
...
Redis:set(HMMODY.."HMMODY:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(HMMODY.."HMMODY:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(HMMODY.."HMMODY:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(HMMODY.."HMMODY:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(HMMODY.."HMMODY:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(HMMODY.."HMMODY:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(HMMODY.."HMMODY:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(HMMODY.."HMMODY:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(HMMODY.."HMMODY:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(HMMODY.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(HMMODY.."HMMODY:Status:Welcome"..msg_chat_id) then
...
Redis:del(HMMODY.."HMMODY:Welcome:Group"..msg_chat_id) 
...
Redis:setex(HMMODY.."HMMODY:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(HMMODY.."HMMODY:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم ازالة قوانين الكروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(HMMODY.."HMMODY:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(HMMODY.."HMMODY:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(HMMODY.."HMMODY:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(HMMODY.."HMMODY:List:Filter"..msg_chat_id)  
if #list == 0 then  
return LuaTele.sendText(msg_chat_id,msg_id,"*- معنده كلمات ممنوعه هنا *","md",true)   
end  
for k,v in pairs(list) do  
v = v:gsub('photo:',"") 
v = v:gsub('sticker:',"") 
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(HMMODY.."HMMODY:Filter:Group:"..v..msg_chat_id)  
Redis:srem(HMMODY.."HMMODY:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(HMMODY.."HMMODY:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(HMMODY..'HMMODY:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(HMMODY..'HMMODY:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*- ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(HMMODY.."HMMODY:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(HMMODY.."HMMODY:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(HMMODY.."HMMODY:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(HMMODY.."HMMODY:All:Get:Reides:Commands:Group"..v)
Redis:del(HMMODY.."HMMODY:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(HMMODY.."HMMODY:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(HMMODY.."HMMODY:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"- الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(HMMODY.."HMMODY:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"- ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(HMMODY.."HMMODY:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(HMMODY.."HMMODY:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(HMMODY.."HMMODY:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(HMMODY.."HMMODY:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(HMMODY.."HMMODY:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(HMMODY.."HMMODY:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(HMMODY.."HMMODY:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(HMMODY.."HMMODY:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(HMMODY.."HMMODY:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(HMMODY.."HMMODY:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(HMMODY.."HMMODY:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(HMMODY.."HMMODY:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(HMMODY.."HMMODY:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '- قناة السورس', url = 't.me/HMMODY'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(HMMODY.."HMMODY:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(HMMODY.."HMMODY:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(HMMODY.."HMMODY:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(HMMODY.."HMMODY:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(HMMODY.."HMMODY:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(HMMODY.."HMMODY:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n- اسف هناك خطا تاكد من البوت ومن الشخص","md",true)  
end 
end
...
Redis:del(HMMODY..'HMMODY:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'- تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(HMMODY..'HMMODY:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'- تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(HMMODY..'HMMODY:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'- تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'- عدد رسائلك هنا *~ '..(Redis:get(HMMODY..'HMMODY:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'- عدد التعديلات هنا *~ '..(Redis:get(HMMODY..'HMMODY:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'- عدد جهاتك المضافه هنا *~ '..(Redis:get(HMMODY.."HMMODY:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(HMMODY.."HMMODY:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
- ارسل الان النص
- يمكنك اضافه :
...
Redis:del(HMMODY.."HMMODY:Set:Id:Groups")
...
Redis:setex(HMMODY.."HMMODY:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
- ارسل الان النص
- يمكنك اضافه :
- `#username` » اسم المستخدم
...
Redis:del(HMMODY.."HMMODY:Set:Id:Group"..msg.chat_id)
...
local Info_Members = Redis:smembers(HMMODY.."HMMODY:DevelopersQ:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"- معنده مطورين ثانوين حاليا , ","md",true)  
end
Redis:del(HMMODY.."HMMODY:DevelopersQ:Groups") 
...
Redis:del(HMMODY.."HMMODY:Developers:Groups") 
...
Redis:del(HMMODY.."HMMODY:TheBasics:Group"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:Originators:Group"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:Managers:Group"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:Addictive:Group"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:Distinguished:Group"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:BanAll:Groups") 
...
Redis:del(HMMODY.."HMMODY:ktmAll:Groups") 
...
Redis:del(HMMODY.."HMMODY:BanGroup:Group"..msg_chat_id) 
...
Redis:del(HMMODY.."HMMODY:SilentGroup:Group"..msg_chat_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"*- تم مسح {"..x.."} من المقيدين *","md",true)
end
...
local list = Redis:smembers(HMMODY.."HMMODY:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(HMMODY.."HMMODY:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(HMMODY.."HMMODY:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف -"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
if #list == 0 then
text = "- عذرا معنده ردود للمدير بالكروب"
end
...
Redis:set(HMMODY.."HMMODY:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(HMMODY.."HMMODY:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(HMMODY.."HMMODY:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(HMMODY.."HMMODY:Add:Rd:Sudo:Gif"..v)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Sudo:vico"..v)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Sudo:stekr"..v)     
Redis:del(HMMODY.."HMMODY:Add:Rd:Sudo:Text"..v)   
Redis:del(HMMODY.."HMMODY:Add:Rd:Sudo:Photo"..v)
Redis:del(HMMODY.."HMMODY:Add:Rd:Sudo:Video"..v)
Redis:del(HMMODY.."HMMODY:Add:Rd:Sudo:File"..v)
Redis:del(HMMODY.."HMMODY:Add:Rd:Sudo:Audio"..v)
Redis:del(HMMODY.."HMMODY:Add:Rd:Sudo:video_note"..v)
Redis:del(HMMODY.."HMMODY:List:Rd:Sudo")
end
...
text = "\n📝قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:File"..v) then
db = "ملف -"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(HMMODY.."HMMODY:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(HMMODY.."HMMODY:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(HMMODY.."HMMODY:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(HMMODY.."HMMODY:SendBcBot") then
...
Redis:setex(HMMODY.."HMMODY:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
- يمكنك ارسال.
          — — — — — — — — — — — — — —
(ملف - ملصق - متحركه - صوره
...
Redis:setex(HMMODY.."HMMODY:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
- يمكنك ارسال.
          — — — — — — — — — — — — — —
(ملف - ملصق - متحركه - صوره
...
Redis:setex(HMMODY.."HMMODY:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
- يمكنك ارسال.
          — — — — — — — — — — — — — —
(ملف - ملصق - متحركه - صوره
...
Redis:setex(HMMODY.."HMMODY:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(HMMODY.."HMMODY:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(HMMODY..'HMMODY:GetTexting:DevHMMODY'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(HMMODY..'HMMODY:Texting:DevHMMODY')
return LuaTele.sendText(msg_chat_id,msg_id,'-  تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevHMMODY = Redis:get(HMMODY..'HMMODY:Texting:DevHMMODY')
if TextingDevHMMODY then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevHMMODY,"md",true)  
else
...
data = {
{
{text = '- 𝘊𝘏𝘈𝘕𝘕𝘌𝘓 𝘚𝘖𝘜𝘙𝘊𝘌.', url = 't.me/HMMODY'}, 
},
{
{text = '- 𝘚𝘖𝘜𝘙𝘊𝘌 𝘗𝘙𝘖𝘎𝘙𝘈𝘔𝘔𝘌𝘙. ', url = 't.me/GBJBOT'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
Redis:setex(HMMODY.."HMMODY:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(HMMODY.."HMMODY:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(HMMODY.."HMMODY:Name:Bot") or "حمد") then
local NamesBot = (Redis:get(HMMODY.."HMMODY:Name:Bot") or "حمد")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي وي حبيبتي ",
"راح ننقرض  وانته بعدك تصيح "..NamesBot,
'يمعود والله نعسان'
}
...
x = x + 1
Redis:srem(HMMODY..'HMMODY:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,HMMODY)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*- البوت عظوبالكروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(HMMODY..'HMMODY:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(HMMODY..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(HMMODY..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(HMMODY..'HMMODY:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(HMMODY.."HMMODY:Game:Smile"..msg.chat_id,SM)
...
Redis:set(HMMODY.."HMMODY:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(HMMODY.."HMMODY:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(HMMODY.."HMMODY:Status:Games"..msg.chat_id) then
Redis:del(HMMODY.."HMMODY:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(HMMODY.."HMMODY:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(HMMODY.."HMMODY:Status:Games"..msg.chat_id) then
Redis:del(HMMODY.."HMMODY:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(HMMODY.."HMMODY:Game:Reflection"..msg.chat_id,name)
...
Redis:set(HMMODY.."HMMODY:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(HMMODY.."HMMODY:Game:Difference"..msg.chat_id,name)
...
Redis:set(HMMODY.."HMMODY:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(HMMODY.."HMMODY:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(HMMODY.."HMMODY:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(HMMODY.."HMMODY:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'ردد','حذف رد')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل  الكل')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'ري','ريمكس')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'ش','شعر')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'تاك','تاك للكل')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط',' رفع مطور')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح',' مسح سحكاتي')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس',' مسح رسائلي')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،',' مسح المكتومين ')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'مدد','  مسح المدراء')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'مم',' مسح المميزين')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'منن',' مسح المنشئين')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'ادد',' مسح الادمنيه')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'ت','  تثبيت')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'مطط',' مسح المطورين')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'تق',' تقيد ')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'تقق',' مسح المقيدين')
Redis:set(HMMODY.."HMMODY:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفعع','  تفعيل الترحيب')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(HMMODY..'HMMODY:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(HMMODY.."HMMODY:Start:Bot") then
local CmdStart = '*\n- أهلآ بك في بوت '..(Redis:get(HMMODY.."HMMODY:Name:Bot") or "حمد")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(HMMODY.."HMMODY:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(HMMODY.."HMMODY:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(HMMODY.."HMMODY:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(HMMODY.."HMMODY:TwaslBot") and not Redis:sismember(HMMODY.."HMMODY:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(HMMODY.."HMMODY:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(HMMODY.."HMMODY:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(HMMODY..'HMMODY:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'- تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(HMMODY..'HMMODY:BaN:In:Tuasl',Info_User)  
...
Redis:srem(HMMODY.."HMMODY:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(HMMODY..'*'..'-100'..data.supergroup.id..'*')
Redis:del(HMMODY.."HMMODY:List:Manager"..'-100'..data.supergroup.id)
Redis:del(HMMODY.."HMMODY:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id == Redis:get(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(HMMODY.."HMMODY:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(HMMODY.."HMMODY:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(HMMODY) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(HMMODY..'HMMODY:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == HMMODY then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(HMMODY..'HMMODY:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(HMMODY.."HMMODY:Lock:edit"..data.chat_id) then
...
Redis:incrby(HMMODY.."HMMODY:Num:Add:Games"..ChatId..IdUser, 1)  
...
- سحكاتي - مجوهراتي.
- كشف البوتات.
- (وضع او ضع ← الاوامر التاليه ).
- اسم ، رابط ، صوره.
- قوانين ، وصف ، ترحيب.
- (حذف او مسح الاوامر التاليه). 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(HMMODY.."HMMODY:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(HMMODY.."HMMODY:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(HMMODY.."HMMODY:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(HMMODY.."HMMODY:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(HMMODY.."HMMODY:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(HMMODY.."HMMODY:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(HMMODY.."HMMODY:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(HMMODY.."HMMODY:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(HMMODY..'HMMODY:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(HMMODY.."HMMODY:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"- تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(HMMODY.."HMMODY:SilentGroup:Group"..ChatId) 
...
if text == "تفعيل غنيلي" and Manager(msg) and ChCheck(msg) then
  local HMMODY = '- هلا يروحي.'..RioRank(msg)..' \n- تم تفعيل غنيلي'
  riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, HMMODY, 14, string.len(msg.sender_user_id_))
  DevRio:del(tarkas..'Rio:Audios:Rio'..msg.chat_id_) 
  end
  if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
  local HMMODY = '- هلا يعمري. '..RioRank(msg)..' \n- تم عطيل غنيلي.'
  riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, HMMODY, 14, string.len(msg.sender_user_id_))
  ...
  keyboard = {}  
  keyboard.inline_keyboard = {{{text="- غير اقنيه .",callback_data="/Song:"..msg.sender_user_id_}},{{text = '⌔ tarkas Team .',url="t.me/DIIIDID"}}} 
  ...
  if text == "تفعيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تفعيل الريمكس" and Manager(msg) and ChCheck(msg) then
    local HMMODY = '- هلا حبيبي . '..RioRank(msg)..' \n- تم تفعيل الريمكسات .
    riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, HMMODY, 14, string.len(msg.sender_user_id_))
    ...
    local HMMODY = '- هلا كلبي .'..RioRank(msg)..' \n-تم تعطيل الريمكسات .'
    riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, HMMODY, 14, string.len(msg.sender_user_id_))
    ...
    local Text ='*واحلا ريمكس للحلو .*'
    keyboard = {}  
    keyboard.inline_keyboard = {{{text="ريمكس قيره",callback_data="/remix:"..msg.sender_user_id_}},{{text = '⌔ tarkas Team .',url="t.me/DIIIDID"}}} 
    local msg_id = msg.id_/2097152/0.5 
